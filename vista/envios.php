...
?>
    ...
    <div class="content-wrapper">
      ...
      <!-- Edit User Modal -->
      <div class="modal " id="add-new-record" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg ">
          <div class="modal-content p-3 p-md-5">
            <div class="modal-body">
              <!-- <button type="button" class="btn-close modal-close" onclick="cancelarform()" data-bs-dismiss="modal" aria-label="Close"></button> -->
