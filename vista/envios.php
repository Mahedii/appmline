                ...
                <form name="formulario" id="formulario" method="POST">
                  <div class="row g-3">
                    <div class="col-lg-3 col-md3 col-sm-3 col-xs-12">
                      ...
                      <select class="js-example-basic-single" name="pais_destino" id="pais_destino" required>
                      </select>
                    </div>
                  ...
                  <div class="pt-4">
                    <button class="btn btn-success me-sm-3 me-1" onmouseover="" type="submit" id="btnGuardar"><i class="fa fa-envelope"></i> Enviar</button>
